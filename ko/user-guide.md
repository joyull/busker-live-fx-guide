...
![앱 홈 화면](../screenshots/home.png)
<!-- SCREENSHOT: 타이틀 바 + 채널 헤더(접힘) + 시그널 체인 + 이펙트 에디터 + 루퍼 바 -->

```
┌───────────────────────────────────────────────┐
│  Busker Live FX        ≡  🎛  ⚙              │  ← 타이틀 바
├───────────────────────────────────────────────┤
│  [ CH1  🎸 Guitar  +3dB·C    ⏻   ⌄ ]         │  ← 채널 헤더 (접힘)
│         • • • •                               │  ← 페이지 도트 (4채널)
├───────────────────────────────────────────────┤
│  [Tu][Cp][EQ][AM][Bo][IR][Db][Ch][Dl][Rv]    │  ← 시그널 체인 바
│  ┌──────────────────────────────────────┐    │
│  │  AMP Simulator              [ ON ]   │    │
│  │  🎛 Gain  Bass  Middle  Treble       │    │  ← 선택된 이펙트 에디터
│  │  🎛 Color Master  Speaker            │    │
│  └──────────────────────────────────────┘    │
├───────────────────────────────────────────────┤
│  🌀 Looper  A●  B○               [ ● ]       │  ← 루퍼 바
├───────────────────────────────────────────────┤
│  -18dB  ─▓▓▓░░░  48kHz  64smp  1.2ms  ✓      │  ← 상태 바
└───────────────────────────────────────────────┘
```
...
![채널 헤더 펼침](../screenshots/channel-expanded.png)
<!-- SCREENSHOT: 채널 헤더 펼쳐진 상태 — 타입 토글 + Gain/Pan 슬라이더 -->
...
<!-- SCREENSHOT: 설정 시트 — 버퍼, 샘플레이트, 백그라운드 오디오, 물리 채널 override -->
